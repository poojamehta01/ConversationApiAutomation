...
import com.api.automation.pojos.response.conversation.GetConversationResponse;
...
public class GetConversationTests {
  ...
  public void getConversationWithConversationIdValid() {
    ...
    GetConversationResponse response = getConversationResponse.as(GetConversationResponse.class);
